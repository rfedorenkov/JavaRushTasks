...
/**
 * Строковые литералы
 * В классе Solution объявлено и проинициализировано публичное строковое поле.
 * Но строка слишком длинная и неудобочитаемая.
 * Для лучшей читаемости нужно разделить её на 5 подстрок
 * и склеить их "оператором +" (конкатенация строк) в таком виде:
 *
