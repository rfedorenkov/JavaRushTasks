 ...
 * все строки по порядку из массива строк, полученного вторым параметром, и возвращает объект
 ...
 * начиная с индекса, полученного третьим параметром, и заканчивая индексом, полученным четвертым
 * параметром, на строку, полученную вторым параметром, и возвращает объект типа StringBuilder на основе этой строки.
...
public class Solution {
    ...
    public static StringBuilder addTo(String string, String[] strings) {
        ...
        Arrays.stream(strings).forEach(result::append);
        return result;
    }
