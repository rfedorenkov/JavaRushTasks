 ...
 *
 * Требования:
 * 1. В методе main необходимо изменить состояние (внутренние переменные) объекта волк wolf.
 * 2. В методе main необходимо изменить состояние (внутренние переменные) объекта дровосек woodman.
