...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        downFire = new RocketFire(Arrays.asList(FIRE_DOWN_1, FIRE_DOWN_2, FIRE_DOWN_3));
        leftFire = new RocketFire(Arrays.asList(FIRE_SIDE_1, FIRE_SIDE_2));
        rightFire = new RocketFire(Arrays.asList(FIRE_SIDE_1, FIRE_SIDE_2));
    }
