 ...
 * 4. В методе writeExternal, на полученном в качестве параметра объекте типа ObjectOutput должен
 * быть вызван метод writeObject с параметром address.
 * 5. В методе writeExternal, на полученном в качестве параметра объекте типа ObjectOutput должен
 * быть вызван метод writeInt с параметром year.
