 ...
 * 3. В классе MarkTwainBook должен быть корректно реализован конструктор
 ...
 * 5. Метод getBook в классе MarkTwainBook должен иметь тип возвращаемого значения MarkTwainBook
 * и возвращать текущий объект.
 ...
 * 8. В классе AgathaChristieBook должен быть корректно реализован конструктор с одним параметром
 ...
 * 10. Метод getBook в классе AgathaChristieBook должен иметь тип возвращаемого значения AgathaChristieBook
 * и возвращать текущий объект.
