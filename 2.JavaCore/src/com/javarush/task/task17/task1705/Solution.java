...
/**
 * Сад-огород
 * 1. Создай метод public void addFruit(int index, String fruit) - который добавляет параметр
 * fruit в лист fruits на позицию index.
 ...
 * 7. Метод addVegetable(int index, String vegetable) должен добавлять параметр vegetable в лист vegetables
 * на позицию index.
