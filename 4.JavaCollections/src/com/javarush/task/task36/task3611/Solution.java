 ...
 * Сегодня рассмотрим часть функционала социальных сетей. Откуда сеть знает,
 * каких людей предлагать тебе в друзья, которых ты можешь знать?
 * Эту задачу легко решить с помощью графов.
 *
 ...
 * (если true - то люди есть друг у друга в друзьях). Если человек с индексом k добавлен
 ...
 * при глубине поиска = 1, для Наташи нужно добавить в результирующее множество Машу.
 * Если глубина поиска = 2, для Наташи нужно добавить в результирующее множество Машу и как потенциального друга Олю.
 * Если глубина поиска = 3, в это же множество нужно добавить еще и всех, с кем дружит Оля.
 ...
 *
 * Requirements:
 * 1. В классе Solution должен существовать публичный
 * метод Set<Integer> getAllFriendsAndPotentialFriends(int index, int deep).
