 ...
 *
 * 2. methodNameToBeReplaced - имя метода, который в текущий список 'list' добавляет те элементы
 * переданной коллекции, которые не содержатся в 'list'.
 *
 ...
 * 2. Метод main, после создания списка правильного типа, должен вызвать метод, который
 * добавит в текущий список 'list' только те элементы переданной коллекции, которые не содержатся в 'list'.
