 ...
 *
 * Requirements:
 * 1. В конструкторе класса Solution в одном catch блоке должны быть обработаны
 * исключения WrongDataException и ConnectionException.
 * 2. В методе write в одном catch блоке должны быть обработаны
 * исключения WrongDataException и ConnectionException.
 * 3. В методе read в одном catch блоке должны быть обработаны
 * исключения WrongDataException и ConnectionException.
 * 4. В методе disconnect в одном catch блоке должны быть обработаны
 * исключения WrongDataException и ConnectionException.
*/
