 ...
 * 4. В классе Constants должна существовать константа SERVER_IS_CURRENTLY_NOT_ACCESSIBLE
 * со значением "The server is not currently accessible.".
 * 5. В классе Constants должна существовать константа USER_IS_NOT_AUTHORIZED
 * со значением "The user is not authorized.".
 * 6. В классе Constants должна существовать константа USER_IS_BANNED
 * со значением "The user is banned.".
 * 7. В классе Constants должна существовать константа ACCESS_IS_DENIED
 * со значением "Access is denied.".
*/
