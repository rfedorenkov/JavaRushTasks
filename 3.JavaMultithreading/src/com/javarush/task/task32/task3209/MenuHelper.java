...
public class MenuHelper {
    ...
    /**
     * Метод создает и добавляет пункт в меню с нужным текстом идобавляет слушателя событий.
     *
     * @param parent         Меню в которое добавляем пункт.
     * @param text           Текст добавляемого пункта.
     * @param actionListener Слушатель действий добавляемого пункта меню
     * @return Возвращает пункт меню.
     */
    public static JMenuItem addMenuItem(JMenu parent, String text, ActionListener actionListener) {
        // Создаем новый пункт меню используя text
        JMenuItem menuItem = new JMenuItem(text);
        // Добавляем слушатель
        menuItem.addActionListener(actionListener);
        // Добавляем созданный пункт меню
        parent.add(menuItem);
        // Возвращаем созданный пункт меню
        return menuItem;
    }
    ...
    public static JMenuItem addMenuItem(JMenu parent, String text, Action action) {
        // Создаем новый пункт меню используя parent и action
    ...
    public static JMenuItem addMenuItem(JMenu parent, Action action) {
        // Создаем новый пункт меню используя action
    ...
    /**
     * Метод инициализирует меню помощи.
     *
    ...
    /**
     * Метод инициализирует меню выбора стиля текста.
     *
     * @param view    Внешний вид.
     * @param menuBar Меню.
     */
    ...
    /**
     * Метод инициализирует меню выбора цвета.
     *
     * @param view    Внешний вид.
     * @param menuBar Меню.
     */
    ...
    /**
     * Метод инициализирует меню выравнивания.
     *
     * @param view    Внешний вид.
     * @param menuBar Меню.
     */
    ...
    /**
     * Метод инициализирует меню редактирования текста.
     *
     * @param view    Внешний вид.
     * @param menuBar Меню.
     */
    ...
    /**
     * Метод инициализирует меню Файл.
     *
     * @param view    Внешний вид.
     * @param menuBar Меню.
     */
