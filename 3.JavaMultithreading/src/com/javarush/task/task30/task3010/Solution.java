 ...
 * Так как рассматриваем позиционные системы счисления - минимальное основание, которое
 * должна выводить программа, это 2.
...
public class Solution {
    public static void main(String[] args) {
        System.out.println(searchAndGetMinimumNumberSystem(args));
    }

    private static String searchAndGetMinimumNumberSystem(String... args) {
