 ...
 *
 * Requirements:
 * 1. В начале строчки вывода должно быть расположено число, которое передано в метод createExpression
 * в качестве параметра и знак "=".
...
public class Solution {
    public static void main(String[] args) {
        ...
        solution.createExpression(74); // 74 = - 1 + 3 - 9 + 81
        solution.createExpression(1234); // 1234 = + 1 - 9 + 27 - 243 - 729 + 2187
        solution.createExpression(2); // 2 = - 1 + 3
    }
    ...
    public void createExpression(int number) {
        ...
        do {
            ...
            number /= 3;
            if (i == 1) {
                sb.append(" + ").append((int) Math.pow(3, count));
            } else if (i == 2) {
                sb.append(" - ").append((int) Math.pow(3, count));
                number++;
            }
