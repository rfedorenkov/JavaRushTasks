 ...
 * 3. В методе someAction анонимного класса Action созданного в классе Solution должен содержаться вызов метода
 * someAction родительского класса (super.someAction()).
